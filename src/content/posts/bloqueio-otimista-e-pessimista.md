...
description: "As duas formas de impedir que gravações simultâneas se atropelem: detectar o conflito com coluna de versão ou evitar travando a linha. Com SQL e Spring Data JPA, `FOR UPDATE` com NOWAIT e SKIP LOCKED, deadlocks, níveis de isolamento do Postgres e o UPDATE condicional."
