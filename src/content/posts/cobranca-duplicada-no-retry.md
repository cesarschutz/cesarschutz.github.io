...
description: "Como garantir que um retry não cobre o cliente duas vezes: chave de idempotência e restrição única no banco, em vez de verificar antes de gravar — com a condição de corrida verifica-e-age, a entrega pelo menos uma vez e as alternativas de bloqueio."
