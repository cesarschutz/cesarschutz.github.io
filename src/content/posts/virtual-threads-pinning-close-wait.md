---
title: "Virtual threads, pinning e CLOSE_WAIT"
published: 2026-09-12
description: "Por que um serviço com virtual threads congela sem erro no log: pinning por bloco `synchronized`, com CLOSE_WAIT como rastro. Estados TCP, carrier threads, thread dump e JFR, bulkhead e circuit breaker com código Java, backpressure e lei de Little."
...
> Formato de diagnóstico: primeiro o sintoma, depois a causa.
...
O diagnóstico começa pelo vocabulário: sem ele, o raciocínio trava. Quatro peças antes do resto.
