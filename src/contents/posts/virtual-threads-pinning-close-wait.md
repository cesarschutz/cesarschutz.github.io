...
enunciado: "Serviço de autorização com virtual threads congela no pico da tarde, sem erro no log: a JVM está viva, o health check estoura e o Kubernetes reinicia o pod. Onde está o problema?"
